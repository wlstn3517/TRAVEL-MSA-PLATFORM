...
/*
 ...
 refresh token은 UUID 기반 → DB 저장 방식으로 별도 관리 (RefreshTokenMapper 참고)
*/
@Component
public class JwtTokenProvider {
	...
	/*
	 * refresh 엔드포인트 전용 access token 생성
	 * Authentication 객체 없이 username + role 문자열만으로 토큰 발급
	 * refresh token 검증 후 DB에서 꺼낸 사용자 정보로 직접 호출
	 */
	public String createAccessTokenForUser(String username, String role) {
